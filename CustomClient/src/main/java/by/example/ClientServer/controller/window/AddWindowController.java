...
import by.example.ClientServer.view.window.AddWindow;
...
public class AddWindowController {
    public static void setController(AddWindow window) {
        window.getAdd().setOnAction(actionEvent -> {
            ...
            window.getHandler().addStudent(new Student(surname, firstName, secondName, groupNumber, workingHoursPerSemester));
